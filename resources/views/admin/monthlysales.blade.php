    ...
    <div class="row">
        <div class="col-md-8">
            <ul class="nav  nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active">Monthly Sales</a>
                </li>
            </ul>
        </div>
    ...
    <div class="mt-2">
        <table class="table table-bordered data-table nowrap" style="width:100%">
            <thead>
                ...
                <td class="text-center">Expenditures</td>
...
$(document).ready(function(){
    $.ajaxSetup({
        ...
        responsive: true,
        select: true,
        ajax: "{{ url('admin/sales/monthly') }}",
        columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex'},
            {data: 'created_at', name: 'created_at', class:'text-left'},  
            {data: 'monthlySales', name: 'monthlySales', class:'text-left', render: $.fn.dataTable.render.number(',', '.', 2, '')},  
            {data: 'monthlyExpenses', name: 'monthlyExpenses', class:'text-left', render: $.fn.dataTable.render.number(',', '.', 2, '')}, 
            {data: 'monthlyExpenditures', name: 'monthlyExpenditures', render: $.fn.dataTable.render.number(',', '.', 2, '')},   
            {data: null, class: 'text-right',  render: function(data, type, row){
                return parseFloat(row.monthlySales - row.monthlyExpenses - row.monthlyExpenditures).toFixed(2)}
            },
